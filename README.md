...
No `latest` tag, please use specific version tags.
 ...
 - [`1.97-alpine-glibc2.44`](https://github.com/Docker-Hub-sirmark/docker-rust-alpine-glibc/blob/main/1.97/alpine-glibc/Dockerfile)

## Docker Pull Command

```console
docker pull sirmark/rust:1.97-alpine-glibc2.44
```
