...
No `latest` tag, please use specific version tags.
 ...
 - [`1.92-alpine-glibc`](https://github.com/Docker-Hub-sirmark/docker-rust-alpine-glibc/blob/main/1.92/alpine-glibc/Dockerfile)

## Docker Pull Command

```console
docker pull sirmark/rust:1.92-alpine-glibc
```
